...
enum PACKET_TYPE { ERROR, PING, CHAT, ALL_NARRATION, GM_ELECT, NEW_GM, LAUNCH_GAME, GAME_LAUNCHED, VOTED, SET_CLID, NEW_NICK,
                ...
                ENTITIES_INFORMATIONS, UPDATE_ENTITY_INFORMATIONS, CREATE_ENTITY, DELETE_ENTITY, INJECT_CODE, SCRIPT_MESSAGE, UPDATE_CHARACTER_LIST };
...
enum ERROR_TYPE { ALREADY_VOTED, GAME_NOT_LAUNCHED, NOT_GM, INVALID_PACKET, INVALID_CANAL, CLIENT_DOES_NOT_EXIST,
            ...
            CANNOT_UPDATE_SCRIPT, CANNOT_OPEN_SCRIPT, CANNOT_RENAME_SCRIPT, CANNOT_DELETE_SCRIPT, CANNOT_CREATE_ENTITY, ENTITY_NOT_FOUND };
